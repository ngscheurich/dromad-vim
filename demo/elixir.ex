...
# unoptimized
final_state =
  Enum.reduce(1..100, HundredDoors.doors(), fn n, acc -> HundredDoors.toggle_every(acc, n) end)
...
# optimized
final_state =
  Enum.reduce(1..10, HundredDoors.doors(), fn n, acc -> HundredDoors.toggle(acc, n * n - 1) end)
